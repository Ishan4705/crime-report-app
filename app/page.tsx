    ...
    <main className="relative px-6 pt-32">
      <div className="mx-auto max-w-5xl">
        <div className="flex flex-col items-center text-center">
            <div className="inline-flex h-9 items-center gap-2  border-4 border-sky-500/20 bg-sky-500/10 px-4 text-sm text-sky-400 hover:bg-sky-500/20">
                <svg
                  className="h-4 w-4"
                  fill="none"
                  viewBox="0 0 24 24"
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            ...
            <Link href={"/how-it-works"}>
              <button className="flex h-12 items-center justify-center gap-2 border bg-white/5 px-8 text-sm font-medium text-white ring-1 ring-inset ring-white/10 transition-all hover:bg-white/10">
                How it Works
              </button>
            </Link>
          </div>
      ...
      <div className="container mx-auto text-center mt-6 max-w-2xl text-lg leading-relaxed text-zinc-400">
        <p>&copy; {new Date().getFullYear()} NukaAlert. All rights reserved.</p>
      </div>
    </footer>
    </main>
  )
